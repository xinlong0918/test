...
;/*!/common/config.js*/
var isOnline = !0, imgOnline = !0, _hmt = _hmt || [];
!function () {
...
_alltrack_conf.push(["_allpage_id", "M_ALL_PAGE_PV_0001"]), function () {
    ...
    var o = imgOnline ? "https://app.jyall.com/web-data/" : "http://10.10.32.59/";
    e.src = o + "swagger/js/trackpv.js";
    var s = document.getElementsByTagName("script")[0];
    s.parentNode.insertBefore(e, s)
}(), define("common/config", ["static/tools/jquery.cookie", "static/tools/lazyload"], function () {
    var e = (/https/i.test(location.protocol) === !1 ? "http://" : "https://") + location.hostname,
        o = (/(A|a)ndroid/i.test(navigator.userAgent), isOnline ? e : "/api.php?jsApiUrl=http://10.10.32.81"),
        s = isOnline ? "?" : "&", t = imgOnline ? "http://image1.jyall.com/v1/tfs/" : "http://10.10.20.51/v1/tfs/",
        r = {trackURL: imgOnline ? "https://app.jyall.com/web-data/" : "http://10.10.32.59/"}, i = {
            http: function (e, o, s, t, r, i, a) {
                var n = {
                    type: "post",
                    dataType: "json",
                    url: e,
                    ...
                    error: function (e, o) {
                        if (console.log("http error:" + o), void 0 != r && null != r) {
                            if (r(), r = null, 1 == a)return !1
                        } else if ("undefined" == typeof a || 0 == a)return;
                        e = null
                    }
                };
                return $.ajax(n)
            }, loadContents: function (e, o, s, t, r, i) {
                var a = "", t = t || !1, n = "", o = o || {};
                n = localStorage.getItem("jyall-Token"), o.token = n, a = isOnline ? e : "/api.php?jsApiUrl=" + e, this.http(a, o, s, t, r, null, i)
            }
        }, a = function (e) {
    ...
    var d = function () {
        ...
        yuy: {
            getPositionList: "http://api.map.baidu.com/place/v2/suggestion",
        ...
        seckill: {seckillUrl: o + "/jysales-api/v1/seckill/getActivityList/"},
        queryPrice: {
            queryPriceUrl: o + "/jygoods-api/v1/goods/skuList/",
            submitQueryUrl: o + "/jygoods-api/v1/entrust/add/11/"
        },
        borderList: {borderListUrl: o + "/common-push/v1/push"},
        bigdata: {
        ...
        navigator.geolocation ? navigator.geolocation.getCurrentPosition(function (o) {
            ...
            BMap.Convertor.translate(s, 0, function (o) {
                $.getJSON("http://api.map.baidu.com/geocoder/v2/?ak=avCvjA6Ko601NmLCQDOKZcyB&callback=?&location=" + o.lat.toFixed(6) + "," + o.lng.toFixed(6) + "&output=json&pois=1", e)
            })
        }, function (o) {
            var s;
            switch (o.code) {
...
;/*!/common/tip.js*/
define("common/tip", ["common/config"], function (t) {
    var e = {
        toast: function (t) {
            if (!$("#toast")[0]) {
                var e = document.createElement("div");
                e.id = "toast", e.className = "toast", e.innerHTML = "<div class = 'toast-out'><div class = 'toast-in' id = 'toast_content'></div></div>", document.body.appendChild(e), $("#toast")[0].addEventListener("webkitAnimationEnd", function () {
                    this.className = "toast"
                }, !1)
            }
            $("#toast_content")[0].innerHTML = t, $("#toast")[0].className += " toasts"
        }, confirm: function (t) {
            if ($("#tip_confirm")[0]) $("#tip_confirm")[0].style.display = "block", $("#mask")[0].style.display = "block"; else {
                var e = document.createElement("div");
                e.id = "tip_confirm", e.className = "tip-confirm", e.innerHTML = (t.title ? "<div class = 'confirm-title'><div>" + t.title + "</div></div>" : "") + "<div><div class = 'content'>" + t.content + "</div></div><div class = 'confirm-button' style='padding-bottom: 0'><span id = 'confirm_no'>" + (t.cancelText ? t.cancelText : "å–æ¶ˆ") + "</span><span id = 'confirm_yes'>" + (t.confirmText ? t.confirmText : "ç¡®å®š") + "</span></div>", document.body.appendChild(e), $("#mask")[0].style.display = "block", $("#tip_confirm")[0].addEventListener("click", function (e) {
                    return "confirm_no" == e.target.id ? ($("#tip_confirm")[0].style.display = "none", $("#mask")[0].style.display = "none", !1) : void("confirm_yes" == e.target.id && t.method && t.method())
                })
            }
        }, alert: function (t) {
            if ($("alert")) $("mask").style.display = "block", $("alert").style.display = "block"; else {
                var e = document.createElement("div");
                e.id = "alert", e.className = "alert", e.innerHTML = (t.title ? "<div class = 'alert-title'>" + (t.titleImg ? "<img src = '" + t.titleImg + "'/> &nbsp;" : "") + t.title + "</div>" : "") + "<div id = 'alert_content'>" + t.content + "</div><span id = 'alert_button' class = 'no-bg'>" + t.btnStr + "</span></div>", document.body.appendChild(e), $("mask").style.display = "block", e.addEventListener("click", function (e) {
                    "alert_button" == e.target.id && t.method && t.method()
                })
            }
        }, ajaxTip: function () {
            if (!$("#loadEffect")[0]) {
                var t = document.createElement("div");
                t.id = "loadEffect", t.className = "loadEffect", t.innerHTML = "<span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span>", document.body.appendChild(t)
            }
            ...
            if (!$("#explain_tip")[0]) {
                var t = document.createElement("div");
                t.className = "explain-tip", t.id = "explain_tip", t.innerHTML = "<span id='close_explain' style='cursor: pointer;'>+</span><div class='iframe'><iframe width='100%' scrolling='yes' height='100%' frameborder='0' name='' src='//m.jyall.com/popup/jydbonus.html'></iframe></div>", document.body.appendChild(t), $(document.body).on("click", "#explain_tip #close_explain", function () {
                    $("#explain_tip").css("display", "none"), $("#mask").css("display", "none")
                }), t.addEventListener("touchmove", function (t) {
                    t.preventDefault(), t.stopPropagation()
                }, !1), $("#mask")[0].addEventListener("touchmove", function (t) {
                    t.preventDefault(), t.stopPropagation()
                }, !1)
            }
            $("#explain_tip").css("display", "block"), $("#mask").css("display", "block")
        }, dialog: function (e, i, n) {
            var a = new Date;
            $.get(t.confURL.dialog.dialogUrl + i, function (t) {
                var i = t[0].path;
                if (a.setTime(a.getTime() + 1e4), $("#dialog")[0]) $("#dialog .tip-main").prop("src", i), $("#dialog")[0].className = "dialog", $("#mask2")[0].style.display = "none"; else {
                    ...
                    s.id = "dialog", s.className = "dialog", s.innerHTML = "<div><img src = '" + i + "'  class = 'tip-main'/><img src = '" + n + "' class = 'close'/></div>", document.body.appendChild(s), console.log(t), $("#dialog .close")[0].addEventListener("click", function () {
...
define("common/genero/getGeneroTpl", ["require"], function () {
    return {generoPop: ["<% var data = obj[0]; %>", '<div class="two-inner font-size14"> ', '<p class="color-666">é‡‘ç®¡å®¶<span><%= data.empName %></span>å°†ä¸ºæ‚¨æœåŠ¡</p>', '<p class="color-999">ç”µè¯ï¼š<span><%= data.telPrefix %>,<%= data.telSuffix %></span></p>', "</div>", '<div class="button">', '<a trackevtid="M_AN_JGJ_Y_0003" class="affirm" href="tel:<%= data.telPrefix %>,<%= data.telSuffix %>">æ‹¨æ‰“ç”µè¯</a>', '<a class="cancel j-getGeneroclose affirm" href="javascript:void(0)">å–æ¶ˆ</a>', "</div>"]}
});
...
define("common/cascadeSelect", ["static/lib/iscroll"], function () {
    ...
    return e.prototype = {
        init: function () {
            ...
            this.ajax(e), console.log(this.data);
            this.evt()
        }, ajax: function (e) {
            $.ajax({
                url: e.url,
        ...
        r = e.View.extend({
            ...
            initialize: function (e) {
                e && e.houseId ? (this.url = t.confURL.genero.secondRentUrl, this.data = {
                    ...
                    address: t.cityID,
                    userId: ""
                }), this.setOptions(e), this.popWarpBox = this.options.popWarpBox, this.popOpenBtn = this.options.popOpenBtn, this.collection = this.options.collection, this.template = this.options.template, this.tpl = this.options.tpl, this.FastClick = this.options.FastClick, this.firstRender = !0, this.initElement(), this.initEvent()
            },
            ...
            render: function () {
                ...
                this.$popWarpBox.html(e), this.firstRender = !1, this.$el.show(), this.initElement()
            },
            error: function () {
                try {
            ...
            getGeneroFun: function () {
                var t = this;
                t.firstRender ? (t.collection.fetch({
                    url: t.url + "?address=" + t.data.address + "&userId=",
                    type: "post",
                    dataType: "json",
                    contentType: "application/json",
                    data: JSON.stringify(t.data),
                    reset: !0
                }), this.$el.show(), $("html,body").css("overflow", "hidden")) : (this.$el.show(), $("html,body").css("overflow", "hidden"))
            },
